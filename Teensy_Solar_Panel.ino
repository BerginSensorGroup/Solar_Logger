...
#define thermocouple1 A2
#define thermocouple2 A3
...
void loop()
{
  ...
  if(iteration == 0){
      commencement = dt.unixtime;
      digitalWrite(greenLEDpin, HIGH);
  }

  //Until time as indicated by time_step has passed, keep reading the voltage measurements
  while(dt.unixtime-commencement < time_step){                  // change this number to determine how often if averages and logs data. in millisecs
